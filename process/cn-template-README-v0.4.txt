...
This customized version of this command line for this Work Product should be included in the "Introduction" section of the accompanying markdown and HTML files.
